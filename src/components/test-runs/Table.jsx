          ...
          <tbody className="divide-y divide-gray-200">
            {testRuns.map((testRun) => (
              <tr key={testRun.id}>
                ...
                <td className="whitespace-nowrap py-4 px-3 text-sm text-gray-500">{testRun.responseTimeMs}ms</td>
                <td className="whitespace-nowrap py-4 px-3 text-sm text-gray-500">{testRun.assertionsPassed}/{testRun.assertions}</td>
